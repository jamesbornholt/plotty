...
class GraphBlock:
    ...
    def processGraph(self, datatable, isHistogram, renderCSV=False, csvIndex=-1, pipeline_hash='', **kwargs):
        ...
        for sc, rows in graph_sets.items():
            ...
            outputs[key] = method(isHistogram, graph_rows, row_keys, column_keys, kwargs['row'], kwargs['column'], kwargs['value'], aggregates, key, pipeline_hash)
    ...
    def renderTable(self, isHistogram, rows, row_keys, column_keys, row_title, column_title, value_title, aggregates, graph_key, pipeline_hash):
        ...
        csv = self.renderCSV(isHistogram, rows, row_keys, column_keys, row_title, column_title, value_title, aggregates, graph_key, pipeline_hash, for_plotting=True)
    ...
    def renderCSV(self, isHistogram, rows, row_keys, column_keys, row_title, column_title, value_title, aggregates, graph_key, pipeline_hash, for_plotting=False):

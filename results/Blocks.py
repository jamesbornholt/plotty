...
class GraphBlock:
    ...
    def processHistogram(self, datatable, renderCSV=False, csvIndex=-1, pipeline_hash='', **kwargs):
        ...
        for sc, rows in graph_sets.items():
            ...
            outputs[key] = method(graph_rows, row_keys, column_keys, kwargs['row'], kwargs['column'], aggregates, key, pipeline_hash)
    ...
    def renderTable(self, rows, row_keys, column_keys, row_title, column_title, aggregates, graph_key, pipeline_hash):

...
def decode_valuefilter_block(data):
    ...
    return {'type': 'valuefilter', 'filters': filters}
...
def encode_valuefilter_block(data):
    filter_strings = []
...
BLOCK_ENCODES = { 'filter': encode_filter_block,
                  ...
                  'valuefilter': encode_valuefilter_block}
